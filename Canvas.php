...
<html lang="en">
    ...
    <body>
        ...
        <div class="canvas">
            ...
            <canvas id="barChart" height="600" width="1130" style="margin-left:-50px"> Votre navigateur ne prend pas en charge Canvas </canvas>
...
//Obtenir Fichier Csv
            $.ajax({
                ...
                success: function (data) {
                    //csvData = csvJSON(data);  
                    csvData = $.csv.toObjects(data);
>>>>>>> 0bcd0c1a32cb45ce1ef228fdb651b526bae50bdd
